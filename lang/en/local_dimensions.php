...
$string['reply'] = 'Reply';
$string['rules_all_outcome_attach'] = 'When all linked sub-competencies are successfully completed, the system will automatically generate and attach evidence proving mastery of this main competency.';
$string['rules_all_outcome_complete'] = 'This main competency will only be marked as complete when all associated sub-competencies are finished, without exceptions.';
$string['rules_all_outcome_recommend'] = 'After completing all sub-competencies, the main competency will be marked as a candidate for completion, but requires manual approval/review by a supervisor before being finally completed.';
$string['rules_assessment_prefix'] = 'Assessment:';
$string['rules_completed_count'] = '{$a->completed} / {$a->total} completed';
$string['rules_label'] = 'Rule:';
$string['rules_no_points'] = '--';
$string['rules_points_outcome_attach'] = 'When the minimum required score from sub-competencies is reached, the system will automatically attach evidence to this main competency, recording the progress.';
$string['rules_points_outcome_complete'] = 'Once the sum of points from completed sub-competencies reaches the required value, this main competency will be automatically validated and marked as complete.';
$string['rules_points_outcome_recommend'] = 'Upon reaching the defined score through sub-competencies, this main competency will be marked as a candidate for completion, but requires manual approval/review by a supervisor before being finally completed.';
$string['rules_progress'] = 'Progress';
$string['rules_pts'] = 'PTS';
$string['rules_required_tag'] = 'Required';
$string['rules_required_warning'] = 'Pay attention to required competencies.';
$string['rules_submit_evidence'] = 'Submit prior learning evidence';
$string['rules_tab'] = 'Rules';
$string['rules_todo'] = 'To do';
$string['rules_total_competencies'] = '{$a} total competencies';
...
$string['enableevidencesubmitbutton_desc'] = 'Show a button in the Rules tab that links to the prior learning evidence page, allowing students to submit evidence of prior learning.';
