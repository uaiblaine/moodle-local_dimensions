...
$string['no_related'] = 'No related {$a}';
...
$string['related_competencies'] = 'Related {$a}';
$string['reply'] = 'Reply';
$string['rules_all_outcome_attach'] = 'Upon successful completion, evidence of mastery will be automatically generated and attached to this {$a}.';
$string['rules_all_outcome_complete'] = 'This {$a} will only be marked as complete when all items are finished, without exceptions.';
$string['rules_all_outcome_recommend'] = 'After completion, this {$a} will be flagged for review by a supervisor before being finally completed.';
...
$string['rules_points_outcome_attach'] = 'When the minimum required score is reached, evidence will be automatically attached to this {$a}, recording the progress.';
$string['rules_points_outcome_complete'] = 'Once the sum of points reaches the required value, this {$a} will be automatically validated and marked as complete.';
$string['rules_points_outcome_recommend'] = 'Upon reaching the defined score, this {$a} will be flagged for review by a supervisor before being finally completed.';
$string['rules_progress'] = 'Progress';
$string['rules_pts'] = 'PTS';
$string['rules_required_tag'] = 'Required';
$string['rules_required_warning'] = 'Pay attention to the required {$a}.';
$string['rules_submit_evidence'] = 'Submit prior learning evidence';
$string['rules_tab'] = 'Rules';
$string['rules_todo'] = 'To do';
$string['rules_total_competencies'] = '{$a->count} {$a->taxonomy} in total';
...
$string['taxonomy_behaviour_plural'] = 'behaviours';
$string['taxonomy_behaviour_singular'] = 'behaviour';
$string['taxonomy_competency_plural'] = 'competencies';
$string['taxonomy_competency_singular'] = 'competency';
$string['taxonomy_concept_plural'] = 'concepts';
$string['taxonomy_concept_singular'] = 'concept';
$string['taxonomy_domain_plural'] = 'domains';
$string['taxonomy_domain_singular'] = 'domain';
$string['taxonomy_indicator_plural'] = 'indicators';
$string['taxonomy_indicator_singular'] = 'indicator';
$string['taxonomy_level_plural'] = 'levels';
$string['taxonomy_level_singular'] = 'level';
$string['taxonomy_outcome_plural'] = 'outcomes';
$string['taxonomy_outcome_singular'] = 'outcome';
$string['taxonomy_practice_plural'] = 'practices';
$string['taxonomy_practice_singular'] = 'practice';
$string['taxonomy_proficiency_plural'] = 'proficiencies';
$string['taxonomy_proficiency_singular'] = 'proficiency';
$string['taxonomy_skill_plural'] = 'skills';
$string['taxonomy_skill_singular'] = 'skill';
$string['taxonomy_value_plural'] = 'values';
$string['taxonomy_value_singular'] = 'value';
