...
| — | **Ilha Material do filtro do aluno reprova em trânsito** | Task 17 mediu: `.local-dimensions-filter-tabs` (`styles.css:3545-3586`) tem **20** tokens em paleta Google Material (`#1a73e8`/`#5f6368`/`#f1f3f4`), não a Boost `#0f6cbf`. O ativo-sobre-indicador passa por 0.01 (4.51:1), mas o **ativo-sobre-plataforma dá 4.05:1** — durante os 320ms de transição, reprova. Sem variante dark. Divergência conhecida, registrada, não corrigida |
