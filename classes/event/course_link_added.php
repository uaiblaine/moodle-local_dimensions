...
/**
 * Event: a competency was linked to a course.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_link_added extends base {
    /**
    ...
    public static function get_name() {
        return get_string('eventcourselinkadded', 'local_dimensions');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' linked the competency with id '{$this->other['competencyid']}' "
            . "to the course with id '{$this->other['courseid']}'.";
    }
