 ...
 *
 * Renders a core/modal_save_cancel (outcome + rule type + points table) from the client-side tree
 * model and resolves with the chosen {ruletype, ruleoutcome, ruleconfig}. Native replacement for
 * tool_lp/competencyruleconfig, which opens a YUI dialogue.
 *
